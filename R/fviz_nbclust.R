...
#'   \strong{average silhouette} and \strong{gap statistics}. Silhouette values
#'   are evaluated only for \code{k = 2, \ldots, k.max} because average
...
#'   a deterministic maximum-distance heuristic: both axes are rescaled to the unit
...
#'   curve. This is the single-knee, parameter-free case of the "Kneedle" method of
#'   \enc{Satopää}{Satopaa} et al. (2011). The heuristic always returns a candidate, even for data
